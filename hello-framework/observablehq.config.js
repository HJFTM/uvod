...
import { mjestoObiteljiPages, obiteljiPages, obiteljiPagesAll} from "./menu.obitelji.js";
...
if (CURRENT_PROJECT === "uvod") {
 ...
 pages = obiteljiPages;
  ...
  pages = [...rod_pages, ...mjestaMenu, ...mjestoObiteljiPages, ...izvoriPages]
...
export const dynamicPaths = () => {
  ...
  const rodPaths = rodovi.flatMap(rod => [
    ...
    `/pages/ROD/bolesti/${encodeURIComponent(rod)}`,
    `/pages/ROD/grobovi/${encodeURIComponent(rod)}`,    
  ]);
